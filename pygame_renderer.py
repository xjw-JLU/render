...
class PyGameTextRenderer(TextRenderingMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.font_file = font_file #字体文件的路径
        self.font_size = font_size
        self.font_color = font_color
        self.background_color = background_color

        self.pixels_per_patch = pixels_per_patch #每个补丁的像素数
        self.max_seq_length = max_seq_length #补丁的最大数量
        self.pad_size = pad_size #内边距大小
        ...
        self.font = None #存储加载后的 pygame 字体对象，该对象用于渲染文本
        self.load_font() #负责加载 font_file 指定的字体文件，并根据设置好的 dpi 和 font_size 创建 pygame 字体对象

    @property
    def max_pixels_len(self): 
        return self.max_seq_length * self.pixels_per_patch #每个渲染图像最大的宽度
